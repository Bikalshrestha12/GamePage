...
import TorusKont from '../components/TorusKont';
...
const MyProfile = () => {
    ...
    if (!user) {
      return <div className="text-center mt-10">Loading... <TorusKont /></div>;
    }
  ...
  //       // const token = localStorage.getItem('token'); // Should return a string token
  ...
  //         }
  //       });
  //       console.log("respones data on my profile", response.data)
  //       setProfile(response.data);  // Set the profile data if successful
  //     } catch (err) {
  ...
  // }, []);
    ...
    return (
      <>
        ...
        <div
          className="p-6 shadow-[0_4px_12px_-5px_rgba(0,0,0,0.4)] w-full max-w-sm rounded-2xl overflow-hidden mx-auto mt-4 mb-5">
          <div className="flex flex-col items-center">
            <div className="min-h-[110px]">
              <img src='https://readymadeui.com/team-1.webp' className="w-28 h-w-28 rounded-full" />
            </div>

            <div className="mt-4 text-center">
              <p className="text-lg text-slate-900 font-semibold">{user?.fullname || 'No full name available'}</p>
