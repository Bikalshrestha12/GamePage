...
const Contact = () => {
  ...
  return (
    <>
    {/* <div className="bg-linear-to-bl from-violet-800 to-fuchsia-700"> */}
    {/* <div className="max-w-3xl mx-auto p-6">
      ...
      {submitted ? (
        ...
        <form onSubmit={handleSubmit} className="bg-white p-8 rounded-lg shadow-md">
          ...
          <div className="mb-4">
            <label htmlFor="message" className="block text-xl font-semibold text-gray-800 mb-2">
              Your Message
            </label>
            <textarea
              id="message"
    ...
    <div className="mt-6 max-w-6xl max-lg:max-w-3xl shadow-lg mx-auto  rounded-lg my-8">
      <div className="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4">
        <div className='mt-10'>
          ...
          <p className="text-sm text-gray-600 mt-6 leading-relaxed">Have some big idea or brand to develop and need help? Then reach out we'd love to hear about your project  and provide help.</p>
        ...
        <div className="bg-green-100 p-6 rounded-lg shadow-md text-center">
          ...
          <form className="mt-8 space-y-4" onSubmit={handleSubmit}>
            <input type='text' placeholder='Name' 
              ...
              onChange={handleNameChange} 
              required
              className="w-full rounded-lg py-3 px-4 text-slate-900 text-sm outline" />
            ...
            <textarea placeholder='Message' rows="6"
              ...
              onChange={handleMessageChange}
              required
              className="w-full rounded-lg px-4 text-slate-900 text-sm pt-3 outline"></textarea>
            <button type='submit'
    ...
    <div className='m-5 hover:shadow-xl blur-xs hover:blur-none'><Map /></div>
